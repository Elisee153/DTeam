                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 offset-xl-1 col-md-6 col-lg-4">
                        <div class="footer_widget">
                            ...
                            <p class="newsletter_text">En nous fournissant votre adresse mail, vous pourrez recevoir toutes les notifications</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <p class="copy_right text-center">
                            ...
                            </script> Tout droit réservé | Designed by DTeam
                            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </p>
                    </div>
                </div>
